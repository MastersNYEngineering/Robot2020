...
public class NewSquareDrive extends OpMode {
    ...
    private CRServo lift0;
    private CRServo lift1;
    ...
    public void init() {
        ...
        lift0 = init_CRservo("lift0");
        lift1 = init_CRservo("lift1");
    }
    ...
    double lift() {
        double right_trigger = gamepad1.right_bumper;
        double left_trigger = gamepad1.right_bumper;
